 ...
 *
 * MyJson class is a Json utility 
 * 1. parse the Json string to Json data
 * 2. toString convert Json data to fomatted string
 * 3. provide setdebug geterror setoption methods for common using
 * This class has implemented the static method for convenient use.
 *
 * </pre>
 *******************************************************************************
 * <B> Author: </B><p><pre>
 ...
 *******************************************************************************
 * <B> Notes: </B><ul>
 *  This is the class for overcome the normal JSON parse failed on invalid token 
 * </ul>
 *******************************************************************************
*/
